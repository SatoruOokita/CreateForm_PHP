                ...
                <div class="col-md-6">
                    <form method="POST" action="input_validation.php">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="contact" row="3" name="contact" placeholder="200字まで" maxlength="200"><?php if (!empty($_POST['contact'])) {
                        ...
                        <br>
                        <input class="btn btn-secondary" type="submit" name="btn_confirm" value="確認画面へ">
